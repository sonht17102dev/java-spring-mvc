            ...
            <div class="container-fluid py-5">
                <div class="container py-5">
                                ...
                                <c:if test="${empty cartDetails}">
                                    <tr>
                                        <td colspan="6" class="text-center text-primary">
                                            <a href="/products" class="btn btn-primary rounded-pill px-4 py-3 text-uppercase">Tiếp tục mua hàng</a>
                                        </td>
                    ...
                    <div class="row mt-4 justify-content-between">
                        ...
                        <form method="post" action="/place-order" modelAttribute="cart" >
                        <div class="col-6 col-md-6 ">
                            ...
                            <a class="btn  px-4 py-3 text-primary text-uppercase mb-4 ms-4" 
                                href="/cart"> <-- Quay lại giỏ hàng</a>
